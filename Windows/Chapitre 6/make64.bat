...
set mincore_lib_path="C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22000.0\um\x64\mincore.lib"
...
%ml64_path% %srcs%\%prog%.asm /link /subsystem:console /defaultlib:%kernel32_lib_path% /defaultlib:%mincore_lib_path% /defaultlib:%ntdll_lib_path% /defaultlib:%user32_lib_path% /entry:Start /out:%binaries%\%prog%.exe /RELEASE
