...
%ml64_path% %srcs%\%prog%.asm /link /subsystem:console /defaultlib:%kernel32_lib_path% /defaultlib:%ntdll_lib_path% /defaultlib:%user32_lib_path% /entry:Start /out:%binaries%\%prog%.exe /RELEASE /LARGEADDRESSAWARE:NO
